...
def get_last_month_data(today):
    # Gets the datetime objects for the start and end of last month.
...
def get_month_data_range(months_ago=1, include_this_month=False):
    # Generates a list of dictionaries that describe an amout of monthly data.
